 ...
 */
function calculatePosition(positionOld, v_horizontal, v_vertical, time_difference, direction) {
    ...
    var v_y = Math.con(alpha) * v_horizontal * kt_ms;
    ...
    var positionNew = new Position(r_x, r_y, r_z);
    return positionNew;
}
